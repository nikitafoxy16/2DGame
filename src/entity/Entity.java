...
public class Entity {
	...
	public int coin;
	public int motion1_duraction;
	public int motion2_duraction;
	...
	//TYPE
	public int type; // 0 = player; 1 = nps; 2 = monster
	...
	public int getTileDistance(Entity target) {
		int tileDistance = (getXdistance(target) + getXdistance(target))/gp.tileSize;
		return tileDistance;
	}
	...
	public void attacking() {
		...
		if(spriteCounter <= motion1_duraction) {
			spriteNum = 1;
		}
		if(spriteCounter > motion1_duraction && spriteCounter <= motion2_duraction) {
			spriteNum = 2;
		...
		if(spriteCounter > motion2_duraction) {
			spriteNum = 1;
			spriteCounter = 0;
			attacking = false;
		}		
...
//    		}
    ...
    public int getDelected(Entity user, Entity target[][], String targetName) {
