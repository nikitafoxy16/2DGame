...
public class Player extends Entity{
	...
	public Player(GamePanel gp, KeyHandler keyH) {
		...
		screenX = gp.screenWight/2 - (gp.tileSize/2);
...
//		worldY = gp.tileSize * 12;
	...
	public int getAttack() {
		 ...
		 motion1_duraction = currentWeapon.motion1_duraction;
	     motion2_duraction = currentWeapon.motion2_duraction;
	...
	public void update() {
            ...
            if(knockBack == true) {
    			...
    			gp.cChecker.checkEntity(this, gp.nps);
			...
			//CHECK NPS COLLISION
			int npsIndex = gp.cChecker.checkEntity(this, gp.nps);
	...
	public void interactNPS(int i) {

		if(gp.keyH.enterPressed == false) {
			
		    if(i != 999) {
				gp.nps[gp.currentMap][i].speak();//FIXED
				gp.nps[gp.currentMap][i].move(direction);
			}	
		}
		else {
			attacking = true;
	...
	public void damageInteractiveTile(int i) {
		...
		if(i != 999 && gp.iTile[gp.currentMap][i].destructible == true //FIXED
			...
			//Generate particle
			generatorParticle(gp.iTile[gp.currentMap][i],gp.iTile[gp.currentMap][i]);//FIXED
...
//				gp.iTile[gp.currentMap][i].checkDrop();
	...
	public void damageProjectile(int i) {
		...
		if(i != 999) {
			...
			generatorParticle(projectile,projectile);
		}
	}
