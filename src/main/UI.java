...
public class UI {
	...
	public void drawTitleScreen() {
			...
			String text = "Blue Boy Anventure";
			...
			//BLUE BOY ADVENTURE
			x = gp.screenWight/2 - (gp.tileSize*2)/2;
			y += gp.tileSize*2;
    ...
    public void drawDialogueScreen() {
    	...
    	int x = gp.tileSize*3;
    	int y = gp.tileSize/2;
    	int width = gp.screenWight - (gp.tileSize*6);
    	int height = gp.tileSize*4;
    	drawSubWindow(x, y, width, height);
    	
    	g2.setFont(g2.getFont().deriveFont(Font.PLAIN,32F)); // marimonica
    	x += gp.tileSize;
    	y += gp.tileSize;
    	
    	if(nps.dialogues[nps.dialogueSet][nps.dialogueIndex] != null) {
    		
//    		currentDialogue = nps.dialogues[nps.dialogueSet][nps.dialogueIndex];
    		
    		char character[] = nps.dialogues[nps.dialogueSet][nps.dialogueIndex].toCharArray();
    	...
    	else {// if no text is it the array
    		nps.dialogueIndex = 0;
    ...
    public void trade_buy() {
    	...
    	if(itemIndex < nps.inventory.size()) {
    		...
    		//BYU AI ITEM
    		if(gp.keyH.enterPressed == true) {
    			if(nps.inventory.get(itemIndex).price > gp.player.coin) {
    				subState = 0;
    				nps.startDialogue(nps, 2);
    			}
    			else {
    				if(gp.player.canObtainItem(nps.inventory.get(itemIndex)) == true) {
    					gp.player.coin -= nps.inventory.get(itemIndex).price;
    				}
    				else {
    					subState = 0;
    					nps.startDialogue(nps, 3);
    				}
    			}
    		}
    	}
    ...
    public int getXforCenteredText(String text) {
    	...
    	int x = gp.screenWight/2 - lenght/2;
    	return x;
    }
